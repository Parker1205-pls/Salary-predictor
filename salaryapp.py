...
if st.button('Predict Salary'):
    ...
    # Transform using the existing LabelEncoder properly
    for col in input_data.columns:
      if col in le:
       input_data[col] = le[col].transform(input_data[col].astype(str))

    # Make sure the input matches model's feature order
